...
`)},{"../../lib/status-colors":46,"choo/html":8}],51:[function(require,module,exports){var MG=require("metrics-graphics");var graph=(timedata,filter)=>{var el=document.createElement("div");MG.data_graphic({title:filter,data:timedata,width:600,height:400,missing_is_zero:true,utc_time:true,target:el,x_accessor:"date",y_accessor:"value"});return el};var createEl=(_timedata,filter)=>{var timedata=_timedata.filter((data=>data.measure.indexOf(filter)>-1)).map((data=>{data.date=new Date(data.date);return data}));return graph(timedata,filter)};module.exports=createEl},{"metrics-graphics":21}],52:[function(require,module,exports){var html=require("choo/html");module.exports=(()=>{return html`
        <footer class="footer">
          <div class="container">
    ...
    `})},{"choo/html":8}],53:[function(require,module,exports){var html=require("choo/html");module.exports=((state,send)=>{if(!state.auth)return html`
          ...
          <div class="box">
            <p class="control has-addons">
              <input class="input is-expanded" id="secret"
                type="password" onkeydown=${e=>{if(e.keyCode==13)send("testAuth",document.getElementById("secret").value)}}></input>
    ...
    `})},{"choo/html":8}],54:[function(require,module,exports){var html=require("choo/html"),navItems={monjs:"#/status",hosts:"#/host",services:"#/service",notify:"#/notify"};module.exports=((state,send)=>{var hash=window.location.hash;if(!hash)hash="#/status";return html`
      <nav class="nav has-shadow">
        <div class="container">
          <div class="nav-left">
            ${Object.keys(navItems).map((nav=>{if(navItems[nav].indexOf(hash)>-1)return html`
    ...
    `})},{"choo/html":8}],55:[function(require,module,exports){var html=require("choo/html");module.exports=(title=>html`
...
`)},{"choo/html":8}],56:[function(require,module,exports){var html=require("choo/html"),banner=require("./helper/banner-view"),nav=require("./helper/nav-view"),footer=require("./helper/footer-view"),title=require("./helper/title-view"),login=require("./helper/login-view"),_=require("lodash");module.exports=((state,prev,send)=>html`
    <div>
      ${banner(state,send)}
      ${nav(state,send)}
      ${title("Hosts")}
              ...
              <div class="container">
                ...
                <p class="control has-addons">
                  <input
                   ...
                   class="input is-expanded"
                   type="text">
                  <a onclick=${()=>send("modalExtraAdd",document.getElementById("addextra").value)} class="button is-info">
                    Add
                  </a>
                </p>
              </div>
      ...
      <div class="container">
        <div class="columns is-centered is-multiline">
          ${state.hosts.filter((host=>{return host.name.indexOf(state.filter)>-1||state.filterTarget!="host"})).map((host=>html`
                  ...
                  <div class="content">
                    ...
                    <p>
                      <a 
                       ...
                       onclick=${()=>send("enableModal",{name:"",address:"",extra_vars:{}})}>
                        Add  
                      </a>
                    </p>
                  </div>      
...
`)},{"./helper/banner-view":49,"./helper/footer-view":52,"./helper/login-view":53,"./helper/nav-view":54,"./helper/title-view":55,"choo/html":8,lodash:20}],57:[function(require,module,exports){var html=require("choo/html"),graph=require("./helper/chart-view"),banner=require("./helper/banner-view"),nav=require("./helper/nav-view"),footer=require("./helper/footer-view"),title=require("./helper/title-view"),login=require("./helper/login-view"),_=require("lodash");module.exports=((state,prev,send)=>html`
    <div>
      ${banner(state,send)}
      ${nav(state,send)}
      ...
      ${login(state,send)}
          ...
          <section class="section">
            <div class="container is-clearfix">
                ...
                <span class="select">
                  <select id="filterSeries-select"
                   oninput=${e=>send("filterSeriesChange",e.target.value)}>
                    ${(()=>{var uniqs=_.map(_.uniqBy(state.timeseries,"measure"),(uniq=>{return uniq.measure}));if(uniqs.length==1&&state.filterSeries!=uniqs[0])return send("filterSeriesChange",uniqs[0]);if(!state.filterSeries||uniqs.indexOf(state.filterSeries)<0)return send("filterSeriesChange",uniqs.slice(-1)[0]);return uniqs.map((uniq=>html`
              ...
              <p class="control">
                <a class="button is-info"
                   onclick=${()=>send("getTimeSeries",{since:+document.getElementById("timeseries-select").value,service:state.params.service})}>
                  Get timeseries
                </a>
              </p>
              </div>
...
`)},{"./helper/banner-view":49,"./helper/chart-view":51,"./helper/footer-view":52,"./helper/login-view":53,"./helper/nav-view":54,"./helper/title-view":55,"choo/html":8,lodash:20}],58:[function(require,module,exports){var html=require("choo/html"),banner=require("./helper/banner-view"),nav=require("./helper/nav-view"),footer=require("./helper/footer-view"),title=require("./helper/title-view"),login=require("./helper/login-view");module.exports=((state,prev,send)=>html`
    <div>
      ${banner(state,send)}
      ${nav(state,send)}
      ${title("Notifications")}
...
`)},{"./helper/banner-view":49,"./helper/footer-view":52,"./helper/login-view":53,"./helper/nav-view":54,"./helper/title-view":55,"choo/html":8}],59:[function(require,module,exports){var html=require("choo/html"),banner=require("./helper/banner-view"),nav=require("./helper/nav-view"),footer=require("./helper/footer-view"),title=require("./helper/title-view"),login=require("./helper/login-view");module.exports=((state,prev,send)=>html`
    <div>
              ...
              <div class="container">
                ...
                <p class="control">
                  <span class="select">
                     <select 
                      ...
                      ${state.hosts.map((host=>{if(state.modalForm.host==host.name)return html`
                ...
                <p class="control">
                  <input
                   ...
                   oninput=${e=>send("modalFormChange",{argstring:e.target.value,args:e.target.value.split(/\s+(?=(?:[^\'\"]*[\'\"][^\'\"]*[\'\"])*[^\'\"]*$)/)})}>
                </p>
                ...
                <p class="control has-addons">
                  <input
                   ...
                   oninput=${e=>send("modalFormChange",{time:+e.target.value,interval:+e.target.value*+document.getElementById("intervalUnit").value})}></input>
                   <span class="select">
                     <select 
                      id="intervalUnit"
                      onchange=${e=>send("modalFormChange",{interval:+e.target.value*+state.modalForm.time})}>
      ...
      <div class="container">
        <div class="columns is-centered is-multiline">
          ${state.services.filter((service=>{return service.name.indexOf(state.filter)>-1||state.filterTarget!="service"})).map((service=>html`
              <div class="column is-3">
                <div class="box">
                  <div class="content">
                    <p>
                ...
                <div class="box">
                  <div class="content">
                    ...
                    <p>
                      <a 
                       class="button is-info"
                       onclick=${()=>{var hostname="";if(state.hosts[0]&&state.hosts[0].name)hostname=state.hosts[0].name;send("enableModal",{name:"",host:hostname,command:"",argstring:"",args:[],time:0,interval:0})}}>
                        Add  
                      </a>
                    </p>
                  </div>      
...
`)},{"./helper/banner-view":49,"./helper/footer-view":52,"./helper/login-view":53,"./helper/nav-view":54,"./helper/title-view":55,"choo/html":8}],60:[function(require,module,exports){var html=require("choo/html"),banner=require("./helper/banner-view"),nav=require("./helper/nav-view"),card=require("./helper/card-view"),footer=require("./helper/footer-view"),title=require("./helper/title-view"),login=require("./helper/login-view");module.exports=((state,prev,send)=>html`
    <div>
        ${banner(state,send)}
        ${nav(state,send)}
        ${title("Status")}
        ...
        <div class="container">
            <div class="columns is-centered is-multiline">
                ${state.status.map((stat=>{if(state.filterTarget=="host"&&stat.hostname.indexOf(state.filter)<0)return;else if(state.filterTarget=="service"&&stat.service.indexOf(state.filter)<0)return;if(state.failFilter&&stat.status=="OK")return;return html`
                        <div class="column is-one-third">
                            ${card({title:stat.hostname,status:stat.status,subtitle:stat.service,body:stat.output,smallbody:`${stat.lastCheck.toLocaleTimeString()} ${stat.lastCheck.toLocaleDateString()}`})}
                        </div>
                    `}))}
            </div>
        </div>
