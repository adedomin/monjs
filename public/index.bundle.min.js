      ...
      ${login(state,send)}
          ...
          <section class="section">
            <div class="container is-clearfix">
              ...
              <p class="control">
                <select id="filterSeries-select"
                 oninput=${e=>send("filterSeriesChange",e.target.value)}>
                  ${_.map(_.uniqBy(state.timeseries,"measure"),(uniq=>{return uniq.measure})).map((measure=>html`
              ...
              <p class="control">
                <a class="button is-info"
                   onclick=${()=>send("getTimeSeries",{since:+document.getElementById("timeseries-select").value,service:encodeURIComponent(state.params.service)})}>
                  Get timeseries
                </a>
              </p>
              </div>
