...
`)},{"../../lib/status-colors":47,"choo/html":8}],52:[function(require,module,exports){var MG=require("metrics-graphics");var graph=(timedata,filter)=>{var el=document.createElement("div");MG.data_graphic({title:filter,data:timedata,width:600,height:400,missing_is_zero:true,utc_time:true,target:el,x_accessor:"date",y_accessor:"value"});return el};var createEl=(_timedata,filter)=>{var timedata=_timedata.filter((data=>data.measure.indexOf(filter)>-1)).map((data=>{data.date=new Date(data.date);return data}));return graph(timedata,filter)};module.exports=createEl},{"metrics-graphics":22}],53:[function(require,module,exports){var html=require("choo/html");module.exports=(()=>{return html`
        <footer class="footer">
          <div class="container">
    ...
    `})},{"choo/html":8}],54:[function(require,module,exports){var html=require("choo/html");module.exports=((state,send)=>{if(!state.auth)return html`
    ...
    `})},{"choo/html":8}],55:[function(require,module,exports){var html=require("choo/html"),navItems={monjs:"#/status",hosts:"#/host",services:"#/service",notify:"#/notify"};module.exports=((state,send)=>{var hash=window.location.hash;if(!hash)hash="#/status";return html`
    ...
    `})},{"choo/html":8}],56:[function(require,module,exports){var html=require("choo/html");module.exports=(title=>html`
...
`)},{"choo/html":8}],57:[function(require,module,exports){var html=require("choo/html"),banner=require("./helper/banner-view"),nav=require("./helper/nav-view"),footer=require("./helper/footer-view"),title=require("./helper/title-view"),login=require("./helper/login-view"),_=require("lodash");module.exports=((state,prev,send)=>html`
    <div>
      ${banner(state,send)}
      ${nav(state,send)}
      ${title("Hosts")}
...
`)},{"./helper/banner-view":50,"./helper/card-view":51,"./helper/footer-view":53,"./helper/login-view":54,"./helper/nav-view":55,"./helper/title-view":56,"choo/html":8}]},{},[44]);