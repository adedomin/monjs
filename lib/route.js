...
module.exports = (STATUS, db, logger) => {
    ...
    apiRoute.get('/status', middleware.getStatus)
    apiRoute.get('/status/:host', middleware.getStatus)
    apiRoute.get('/status/:host/:service', middleware.getStatus)
