...
This tool might be useful to you if you require a simple service to monitor a small set of servers and services.
This tool has not been performance tested for thousands of checkers.
